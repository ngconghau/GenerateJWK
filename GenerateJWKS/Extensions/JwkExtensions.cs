...
namespace Jwk.Generator
{
    ...
    {
        internal static readonly JsonSerializerSettings IndentedSettings = new JsonSerializerSettings()
        {
        ...
        public static string SerializeToJson(this Jose.Jwk jwk, bool indented = true)
        {
            JoseJwkSerializationWrapper wrapper = new JoseJwkSerializationWrapper()
            {
                Kty = jwk.Kty,
                Kid = jwk.KeyId,
                Alg = jwk.Alg,
                ...
                X5c = jwk.X5C,
                X5t = jwk.X5T,
                X5tS256 = jwk.X5TSha256,
                X5u = jwk.X5U,
                OtherParams = jwk.OtherParams,
            };
            return JsonConvert.SerializeObject(wrapper, indented ? IndentedSettings : Settings);
        }
        ...
        internal class JsonWebKeySerializationWrapper
        {
            ...
            public bool ShouldSerializeOth()
            {
                return Oth?.Count > 0;
            }

        }
        internal class JoseJwkSerializationWrapper
        {
            [JsonProperty("kty")]
            public string? Kty { get; set; }
            ...
            public bool ShouldSerializeOtherParams()
            {
                return OtherParams?.Count > 0;
            }
